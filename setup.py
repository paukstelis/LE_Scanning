...
plugin_identifier = "scanning"

# The plugin's python package, should be "octoprint_<plugin identifier>", has to be unique
plugin_package = "LE_scanning"

# The plugin's human readable name. Can be overwritten within OctoPrint's internal data via __plugin_name__ in the
# plugin module
plugin_name = "LE_Scanning"
...
# module
plugin_description = """Probe scanning for LatheEngraver"""
...
plugin_url = "https://github.com/paukstelis/LE_Scanning"

# The plugin's license. Can be overwritten within OctoPrint's internal data via __plugin_license__ in the plugin module
plugin_license = "AGPLv3"

# Any additional requirements besides OctoPrint should be listed here
plugin_requires = ["numpy","numpy-stl"]
